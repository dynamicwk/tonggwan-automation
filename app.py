...
# ==========================================
# 📑 탭 1: 세관 통관 정산 마스터 시스템 (100% 완전 복구 완료)
# ==========================================
with tab1:
...
# ==========================================
# 📦 탭 2: 해상물류비 마감정산 (공장입고) (100% 완전 복구 완료)
# ==========================================
with tab2:
    ...
    with l_col1:
        ...
        st.markdown("---")
        pantos_btn = st.button("🚀 최종 물류비 마스터대장 산출하기", use_container_width=True, key="pantos_trigger_btn")
                        ...
                        if not processed_list:
                            ...
                            with pd.ExcelWriter(ap_excel, engine='xlsxwriter') as writer:
                                ...
                                for p_name in unique_pnames:
                                    ...
                                    # 품명별 루프 작성 (첫 데이터 로우에만 대포 품명 이름 표기)
